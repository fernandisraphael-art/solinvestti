  ...
  return (
    <div className="min-h-screen bg-white font-sans flex flex-col selection:bg-primary/30 overflow-x-hidden">
      ...
      <main className="flex-1 flex flex-col lg:flex-row overflow-hidden">
        <div className="lg:w-[400px] p-6 lg:p-10 space-y-8 overflow-y-auto bg-white border-r border-slate-50">
          <div>
            <h3 className="text-xl lg:text-2xl font-display font-black mb-8 text-brand-navy tracking-tight">Parâmetros de Alocação</h3>
        ...
        <div className="flex-1 bg-brand-deep p-6 lg:p-12 lg:m-6 lg:rounded-[3rem] text-white flex flex-col relative overflow-hidden shadow-2xl border border-white/5">
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-primary/10 rounded-full blur-[140px] -mr-48 -mt-48 opacity-60"></div>
          <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-blue-500/10 rounded-full blur-[100px] -ml-24 -mb-24 opacity-40"></div>

          <div className="relative z-10 flex-1 flex flex-col">
            <div className="inline-flex px-4 py-2 rounded-full border border-white/10 text-[10px] font-black uppercase tracking-[0.3em] text-primary mb-12 self-start bg-white/5 backdrop-blur-md">
              PROJEÇÃO PATRIMONIAL INSTITUCIONAL
            </div>

            <div className="flex flex-col mb-16">
              <div className="flex items-start gap-3 lg:gap-5">
                <span className="text-4xl lg:text-6xl font-display font-black leading-none opacity-80 mt-2 lg:mt-4">R$</span>
                <h2 className="text-5xl lg:text-8xl xl:text-9xl font-display font-black tracking-tighter leading-none animate-in slide-in-from-left duration-700">
                  {Number(integerPart).toLocaleString('pt-BR')}
                </h2>
              </div>
              <div className="text-3xl lg:text-6xl font-display font-black text-white/20 ml-12 lg:ml-32 -mt-2 tracking-tighter">
                ,{decimalPart}
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16 pt-8 lg:pt-12 border-t border-white/5">
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-1000">
                <p className="text-[10px] font-black text-white/40 uppercase tracking-[0.3em] mb-3">TOTAL APORTADO</p>
                <p className="text-2xl lg:text-4xl font-display font-black">R$ {totalInvested.toLocaleString('pt-BR', { minimumFractionDigits: 0 })}</p>
              </div>
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-100">
                <p className="text-[10px] font-black text-white/40 uppercase tracking-[0.3em] mb-3">LUCRO PROJETADO</p>
                <div className="flex items-baseline gap-2">
                  <span className="text-primary text-xl font-black">R$</span>
                  <p className="text-2xl lg:text-4xl font-display font-black text-primary">
            ...
            <div className="mt-auto pt-12 h-64 lg:h-80 flex items-end justify-between gap-1 group/chart px-2 relative">
